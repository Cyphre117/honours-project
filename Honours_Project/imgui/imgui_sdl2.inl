...
void ImGui::Frame(SDL_Window* window, VRSystem* vr_system )
{
	...
	{
		glm::vec2 touch_delta = vr_system->leftControler()->touchpadDelta();
		touch_delta *= 500.0f;
		io.MousePos.x += touch_delta.x;
		io.MousePos.y -= touch_delta.y;

		io.MouseDown[0] = vr_system->leftControler()->isButtonDown( vr::k_EButton_SteamVR_Trigger );
	}
